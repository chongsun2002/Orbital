 ...
 */
async function sendFriendRequest(requesterId: string, recipientId: string, isSecret: boolean): Promise<FriendRequest> {
 ...
 */
async function acceptFriendRequest(requesterId: string, recipientId: string) {
 ...
 * @param recipientId id of the recipient 
 */
async function declineFriendRequest(requesterId: string, recipientId: string) { 
 ...
 */
async function isFriends(user1Id: string, user2Id: string): Promise<boolean> {
 ...
 */
async function getPendingOutgoing(userId: string) {
 ...
 * @returns a list of ids of users who have a pending friend request from our specified user
 */
async function getPendingIncoming(userId: string) {
...
export { sendFriendRequest, acceptFriendRequest, declineFriendRequest, isFriends, 
    getFriends, getPendingIncoming, getPendingOutgoing, removeFriend };